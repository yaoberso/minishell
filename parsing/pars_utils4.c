...
//         (*end)++;
//     return (*end - start - 1 > 0) ? ft_substr(str, start + 1, *end - start - 1) : NULL;
// }

// char *replace_var_in_str(char *str, int start, char *var_value, int end)
// {
//     int len_before = start;
//     int len_after = ft_strlen(str + end);
//     char *result = malloc(len_before + ft_strlen(var_value) + len_after + 1);
//     if (!result)
//         return NULL;
